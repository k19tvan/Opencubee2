...
const SHORTCUTS = [
  ...
  { label: 'Lock Video Delete (Exclude from search)', keys: 'Hover frame, then Alt + 6' },
  ...
  { label: 'Spatial search: left side of focused cell', keys: 'Alt + 1' },
  { label: 'Spatial search: right side of focused cell', keys: 'Alt + 2' },
  { label: 'Spatial search: top of focused cell', keys: 'Alt + 3' },
  { label: 'Spatial search: bottom of focused cell', keys: 'Alt + 4' },
  { label: 'Toggle Time Range Filter', keys: 'Alt + 5' },
