...
const SHORTCUTS = [
  ...
  { label: 'Toggle left-half spatial search (a + c)', keys: 'Alt + 1' },
  { label: 'Toggle right-half spatial search (b + d)', keys: 'Alt + 2' },
  { label: 'Toggle top-half spatial search (a + b)', keys: 'Alt + 3' },
  { label: 'Toggle bottom-half spatial search (c + d)', keys: 'Alt + 4' },
